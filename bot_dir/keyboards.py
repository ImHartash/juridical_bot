...
start_keyboard = InlineKeyboardMarkup(inline_keyboard=[
    ...
    [
        InlineKeyboardButton(text='Примеры документов', callback_data="docs_examples"),
...
help_keyboard = InlineKeyboardMarkup(inline_keyboard=[
    ...
    [
        InlineKeyboardButton(text='Вернуться на главную страницу', callback_data="back"),
    ]
])

gpt_question = InlineKeyboardMarkup(inline_keyboard=[
    [
        InlineKeyboardButton(text='Продолжить генерацию', callback_data="continue_generation"),
        InlineKeyboardButton(text='Закончить генерацию', callback_data="question_ia")
    ]
])
...
docs_menu = InlineKeyboardMarkup(inline_keyboard=[
    [
        InlineKeyboardButton(text='Назад', callback_data='docs_examples')
    ]
])

changekb = InlineKeyboardMarkup(inline_keyboard=[
    [
...
gpt_keyboard = ReplyKeyboardMarkup(keyboard=[[
